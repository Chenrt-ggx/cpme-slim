...
const bind = { minitems: 1, maxitems: 1, enabled: !!1, removed: !!0, number: 1 };
...
DisableDevtool({ ondevtoolopen: () => false });
...
onMounted(() => {
  ...
  setInterval(() => {
    context1.clearRect(0, 0, document.body.clientWidth, document.body.clientHeight);
    context2.clearRect(0, 0, document.body.clientWidth, document.body.clientHeight);
    context3.clearRect(0, 0, document.body.clientWidth, document.body.clientHeight);
    context4.clearRect(0, 0, document.body.clientWidth, document.body.clientHeight);
    context1.fillText(payload.part2[0], 0, 24);
    context2.fillText(payload.part2[1], 0, 24);
    context3.fillText(payload.part2[2], 0, 24);
    context4.fillText(payload.part2[3], 0, 24);
